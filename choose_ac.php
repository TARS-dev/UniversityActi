...
<div id="mySidenav" class="sidenav">
  ...
  <a href="choose_ac.php " style="color: #640200;
   background-color: #F5DD37;">กิจกรรมเลือก</a>
...
<span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; </span>
  <h2>ยินดีต้อนรับสู่หน้ากิจกรรมเลือก</h2>
...
$stid = oci_parse($conn, "SELECT * FROM activities where catid=3 and activitiesname||activitiesid like '%$search%' order by status desc");
oci_execute($stid);
?>

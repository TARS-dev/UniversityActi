...
<?php
    ...
    $sql = "SELECT * from show_t where studentid = $r";
    ...
    // ]);
    ?>
    <a href="teach_show.php" class='btn btn-warning'>กลับไปหน้าข้อมูลกิจกรรม</a>
...
<a href="MyPDFt.pdf">Download PDF</a>
</div>
</body>
</html>

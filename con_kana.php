...
<a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
  <a href="fac_show.php" >ข้อมูลกิจกรรมนักศึกษา</a>
   ...
   <a href="con_kana.php" style="color: #640200;
   background-color: #F5DD37;">ยืนยันการทำกิจกรรม</a>
...
<span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; </span>
  <h2>ยินดีต้อนรับเข้าสู่หน้ายืนยันกิจกรรมของนักศึกษา</h2>
...
$stid = oci_parse($conn, "SELECT IDNUMBER,APPILCATIONDATE,s.STUDENTNAME,r.ACTIVITIESID,a.ACTIVITIESNAME,r.STUDENTID,DATEACTIVITIES from register r,activities a,students s where s.STUDENTID = r.STUDENTID AND r.activitiesid = a.activitiesid ");
oci_execute($stid);
?>
...
<th scope='col'style='text-align:center'>รหัสนักศึกษา</th>
        ...
        <th scope='col'style='text-align:center'>ยืนยัน</th>
        <th scope='col'style='text-align:center'>ไม่เข้ากิจกรรม</th>
</tr>
<?php 
  while (($row = oci_fetch_array($stid, OCI_BOTH)) != false) {
    echo "<tr align='center'>";
    if($row['DATEACTIVITIES']==NULL){
    ...
    <td><?php echo $row['STUDENTID']?></td>
        ...
        ?>
        <td><a href="confirm_kana.php?ids=<?php echo $row['STUDENTID']?>&ida=<?php echo $row['ACTIVITIESID']?>"class='btn btn-success'>ยืนยัน</a></td>
        <td><a href=""class='btn btn-danger'>ไม่มีการทำกิจกรรม</a></td>
